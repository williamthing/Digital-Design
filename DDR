...
module Lab3(CLOCK_50, SW, LEDR, KEY, HEX0, HEX1, HEX2, HEX3, HEX4, HEX5, GPIO_0); 
	...
	*/
	...
	move_light col3_6 (oo, SW[9], green_array[2][3], green_array[1][3]);
	move_light col3_7 (oo, SW[9], green_array[1][3], green_array[0][3]);
	...
	move_light col2_6 (oo, SW[9], green_array[2][2], green_array[1][2]);
	move_light col2_7 (oo, SW[9], green_array[1][2], green_array[0][2]);
	...
	move_light col1_6 (oo, SW[9], green_array[2][1], green_array[1][1]);
	move_light col1_7 (oo, SW[9], green_array[1][1], green_array[0][1]);
	...
	move_light col0_6 (oo, SW[9], green_array[2][0], green_array[1][0]);
	move_light col0_7 (oo, SW[9], green_array[1][0], green_array[0][0]);
	...
	/*
	// Buttons for user to hit the dots
	// points
	wire t3, t2, t1, t0;
	button trigger3 (.Clock(clk[whichClock]) , .Reset(SW[9]), .pressed(~KEY[3]), .set(t3));
	button trigger2 (.Clock(clk[whichClock]) , .Reset(SW[9]), .pressed(~KEY[2]), .set(t2));
	button trigger1 (.Clock(clk[whichClock]) , .Reset(SW[9]), .pressed(~KEY[1]), .set(t1));
	button trigger0 (.Clock(clk[whichClock]) , .Reset(SW[9]), .pressed(~KEY[0]), .set(t0));
	*/
